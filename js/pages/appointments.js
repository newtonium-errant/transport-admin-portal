        ...
        if (typeof appointmentModalInstance !== 'undefined' && appointmentModalInstance) {
            ...
            try {
                ...
                if (mode === 'edit') {
                    ...
                    endpoint = 'https://webhook-processor-production-3bb8.up.railway.app/webhook/update-appointment-complete-v5_5';
                    payload = appointmentData;
                } else {
                    // v7 Add endpoint - uses pre-calculated travel times (simplified payload)
                    endpoint = 'https://webhook-processor-production-3bb8.up.railway.app/webhook/save-appointment-v5';
